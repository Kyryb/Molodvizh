...
document.addEventListener("DOMContentLoaded", function () {
  var languages = document.querySelectorAll(".header__language");
  console.log(languages);
  languages.forEach(function (lang) {
    lang.addEventListener('click', function () {
      if (!lang.classList.contains("header__language--active")) {
        languages.forEach(function (otherLang) {
          otherLang.classList.contains("header__language--active") ? otherLang.classList.remove("header__language--active") : otherLang;
        });
